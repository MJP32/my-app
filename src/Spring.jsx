  ...
  return (
    <div style={{
      ...
      <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} style={{ overflow: 'visible' }}>
        ...
        <g opacity="0.1">
          <rect x="50" y="180" width="420" height="200" rx="16" fill="#10b981" />
          <text x="260" y="210" textAnchor="middle" fontSize="14" fontWeight="700" fill="#059669" opacity="0.6">
            Core Layer
          </text>

          <rect x="550" y="80" width="420" height="560" rx="16" fill="#3b82f6" />
          <text x="760" y="110" textAnchor="middle" fontSize="14" fontWeight="700" fill="#1e40af" opacity="0.6">
            Application Layer
          </text>
