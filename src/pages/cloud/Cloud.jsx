...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  default_node_pool {
    ...
    },
    {
      ...
      icon: '🏗️',
      color: '#f59e0b',
      description: 'Designing scalable, resilient, and efficient cloud architectures with best practices. Provider-agnostic scaling, load balancing, caching and database optimization are covered on the dedicated Scaling, Load Balancing, Caching Strategies and Database Optimization pages under Design > System Design Topics.',
