...
function FunctionalInterfaces({ onBack, onPrevious, onNext, previousName, nextName, currentSubcategory, previousSubcategory, nextSubcategory, onPreviousSubcategory, onNextSubcategory }) {
          ...
          <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', border: '2px solid #e5e7eb', maxHeight: '85vh', overflowY: 'auto' }}>
            ...
            {selectedQuestion.explanation && (
              <div style={{ marginTop: '1.5rem' }}>
                ...
                <pre style={{ fontSize: '0.95rem', color: '#6b7280', lineHeight: '1.6', whiteSpace: 'pre-wrap', fontFamily: 'system-ui' }}>{selectedQuestion.explanation}</pre>
              </div>
            )}
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto', backgroundColor: '#f0f9ff', minHeight: '100vh' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: '800', color: '#1f2937', marginBottom: '0.5rem' }}>⚡ Functional Interfaces</h1>
        <p style={{ fontSize: '1.2rem', color: '#6b7280' }}>Master functional interfaces for lambda expressions and functional programming</p>
