...
describe('Multithreading', () => {
  ...
  it('renders the Executor Framework concept card', () => {
    render(<Multithreading onBack={mockOnBack} breadcrumb={mockBreadcrumb} />)
  ...
  it('renders all existing concept cards alongside Executor Framework', () => {
    ...
    expect(screen.getByText('ExecutorService & Thread Pools')).toBeInTheDocument()
    expect(screen.getByText('Callable & Future')).toBeInTheDocument()
    expect(screen.getByText('Synchronization')).toBeInTheDocument()
    expect(screen.getByText('Thread Coordination')).toBeInTheDocument()
    expect(screen.getByText('ThreadLocal')).toBeInTheDocument()
    expect(screen.getByText('Volatile & Atomics')).toBeInTheDocument()
  ...
  describe('Executor Framework concept', () => {
    it('opens modal when card clicked', () => {
      ...
      // Multithreading page uses just "✕" for concept modal close button
  ...
  describe('modal interactions', () => {
    it('closes modal when close button clicked', () => {
      ...
      // Multithreading page concept modal uses just "✕" for close
    ...
    it('closes modal on Escape key', () => {
      ...
      // Multithreading page listens on document, not window
