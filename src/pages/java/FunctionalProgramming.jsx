...
function FunctionalProgramming({ onBack, breadcrumb, onNavigateTopic }) {
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto 2rem' }}>
        ...
        />
        {onNavigateTopic && (
          <div style={{ marginTop: '1rem', padding: '0.9rem 1.2rem', backgroundColor: 'rgba(139, 92, 246, 0.08)', border: '1px solid rgba(139, 92, 246, 0.35)', borderRadius: '12px', color: '#e5e7eb', display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '0.75rem' }}>
            <span>This page focuses on the FP mindset &mdash; pure functions, immutability and reactive streams. Lambda syntax, method references, higher-order functions and the Stream API each have dedicated pages:</span>
            <button
              onClick={() => onNavigateTopic('Lambdas')}
            ...
            <button
              ...
              style={{ background: '#3b82f6', color: 'white', border: 'none', padding: '0.4rem 0.9rem', borderRadius: '8px', fontWeight: 700, cursor: 'pointer' }}
            >
              Stream API &rarr;
            </button>
          </div>
