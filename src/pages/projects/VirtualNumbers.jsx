...
function VirtualNumbers({ onBack, breadcrumb }) {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto', backgroundColor: '#f0fdfa', minHeight: '100vh' }}>
      {/* Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontSize: '2.5rem', fontWeight: '800', color: '#1f2937', margin: 0, textAlign: 'center' }}>
          🔢 Virtual Numbers
        </h1>
      ...
      {activeTab === 'overview' && (
        <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
            <div style={{ padding: '1.5rem', backgroundColor: '#eff6ff', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.75rem' }}>
                🏦 Major Industry Identifier (MII)
              </h3>
              <p style={{ color: '#4b5563', lineHeight: '1.6', marginBottom: '0.5rem' }}>
            ...
            <div style={{ padding: '1.5rem', backgroundColor: '#fdf4ff', borderRadius: '8px', borderLeft: '4px solid #a855f7' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.75rem' }}>
                ✅ Check Digit (Luhn)
              </h3>
              <p style={{ color: '#4b5563', lineHeight: '1.6', marginBottom: '0.5rem' }}>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', backgroundColor: '#fef2f2', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
            <h3 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.75rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
              <div>
                <strong style={{ color: '#1f2937' }}>Storage Rules:</strong>
                <ul style={{ color: '#4b5563', lineHeight: '1.6', marginLeft: '1.5rem', marginTop: '0.5rem' }}>
              ...
              <div>
                <strong style={{ color: '#1f2937' }}>Transmission:</strong>
                <ul style={{ color: '#4b5563', lineHeight: '1.6', marginLeft: '1.5rem', marginTop: '0.5rem' }}>
          ...
          {cardExamples.map((card, idx) => (
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', fontWeight: '700', color: '#1f2937', letterSpacing: '0.1em', fontFamily: 'monospace' }}>
                  {card.displayNumber}
                </div>
              </div>

              <h4 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#1f2937', marginBottom: '1rem' }}>
                Number Breakdown:
              </h4>
                ...
                {card.breakdown.map((part, partIdx) => (
                  <div
                    ...
                    style={{
                      ...
                      alignItems: 'center',
                      padding: '1rem',
                      backgroundColor: partIdx % 2 === 0 ? '#f9fafb' : '#ffffff',
                      borderRadius: '6px',
                      gap: '1rem'
                    }}
                  >
      ...
      {activeTab === 'luhn' && (
        <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: '#eff6ff', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
            <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1f2937', marginBottom: '1rem' }}>
              How It Works
            </h3>
            {luhnSteps.map((step, idx) => (
              <div key={idx} style={{ marginBottom: '1.5rem' }}>
                <div style={{ fontWeight: '600', color: '#1f2937', marginBottom: '0.5rem', fontSize: '1.05rem' }}>
                  {step.step}
                </div>
                <div style={{
                  padding: '1rem',
                  ...
                  <div style={{ color: '#6b7280', fontSize: '0.9rem', marginBottom: '0.25rem' }}>Input:</div>
                  <div style={{ fontSize: '1.1rem', color: '#1f2937', marginBottom: '0.75rem' }}>{step.example}</div>
                  <div style={{ color: '#6b7280', fontSize: '0.9rem', marginBottom: '0.25rem' }}>Output:</div>
                  <div style={{ fontSize: '1.1rem', color: '#14b8a6', fontWeight: '600' }}>{step.result}</div>
                </div>
                <div style={{ color: '#6b7280', fontSize: '0.95rem', fontStyle: 'italic' }}>
                  💡 {step.explanation}
                </div>
              </div>
            ))}
          ...
          <div style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: '#f0fdf4', borderRadius: '8px', borderLeft: '4px solid #10b981' }}>
            <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1f2937', marginBottom: '1rem' }}>
            ...
            <div style={{ fontFamily: 'monospace', marginBottom: '1rem' }}>
              <div style={{ marginBottom: '0.75rem' }}>
                ...
                <span style={{ color: '#6b7280' }}>Original: </span>4 5 3 2 0 1 5 1 1 2 8 3 0 3 6 6<br/>
                <span style={{ color: '#6b7280' }}>Doubled:  </span>8 5 6 2 0 1 10 1 2 2 16 3 0 3 12 6
              </div>
              <div style={{ marginBottom: '0.75rem' }}>
                <strong>Step 2 - Sum digits of doubled values:</strong><br/>
                <span style={{ color: '#6b7280' }}>Adjusted: </span>8 5 6 2 0 1 1 1 2 2 7 3 0 3 3 6<br/>
                <span style={{ fontSize: '0.9rem', color: '#6b7280' }}>(10→1+0=1, 16→1+6=7, 12→1+2=3)</span>
              </div>
              <div style={{ marginBottom: '0.75rem' }}>
          ...
          <div style={{ padding: '1.5rem', backgroundColor: '#fef2f2', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
              <div>
                <div style={{ fontWeight: '600', color: '#1f2937', marginBottom: '0.5rem' }}>✅ Error Detection</div>
                <ul style={{ color: '#4b5563', lineHeight: '1.6', marginLeft: '1.5rem' }}>
              ...
              <div>
                <div style={{ fontWeight: '600', color: '#1f2937', marginBottom: '0.5rem' }}>⚠️ Limitations</div>
                <ul style={{ color: '#4b5563', lineHeight: '1.6', marginLeft: '1.5rem' }}>
              ...
              <div>
                <div style={{ fontWeight: '600', color: '#1f2937', marginBottom: '0.5rem' }}>🎯 Use Cases</div>
                <ul style={{ color: '#4b5563', lineHeight: '1.6', marginLeft: '1.5rem' }}>
      ...
      {activeTab === 'networks' && (
        <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', backgroundColor: '#fef3c7', borderRadius: '8px', borderLeft: '4px solid #f59e0b' }}>
            <h3 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.75rem' }}>
        ...
        <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
            ...
            {cardLengths.map((card, idx) => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '1rem' }}>
                  <div>
                    <h3 style={{ fontSize: '1.4rem', fontWeight: '700', color: '#1f2937', margin: 0, marginBottom: '0.5rem' }}>
                      {card.network}
                    </h3>
                    <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                      <div>
                        <span style={{ color: '#6b7280', fontSize: '0.9rem' }}>Length: </span>
                        <span style={{ fontWeight: '600', color: '#1f2937' }}>{card.length} digits</span>
                      </div>
                      <div>
                        <span style={{ color: '#6b7280', fontSize: '0.9rem' }}>Prefix: </span>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', backgroundColor: '#eff6ff', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
            ...
            <div style={{ color: '#4b5563', lineHeight: '1.8' }}>
              <strong>When validating card numbers programmatically:</strong>
              <ol style={{ marginLeft: '1.5rem', marginTop: '0.5rem' }}>
                <li><strong>Check length first</strong> - Reject if not 13-19 digits</li>
                <li><strong>Validate prefix</strong> - Ensure it matches a known network</li>
                <li><strong>Run Luhn algorithm</strong> - Verify checksum is valid</li>
                <li><strong>Match length to network</strong> - e.g., Amex must be 15 digits</li>
                <li><strong>Remove spaces/dashes</strong> - Strip formatting before validation</li>
              </ol>
            </div>
          </div>

          <div style={{ marginTop: '1.5rem', padding: '1.5rem', backgroundColor: '#fef2f2', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
            <h3 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.75rem' }}>
              ⚠️ Important Notes
            </h3>
            <ul style={{ color: '#4b5563', lineHeight: '1.8', marginLeft: '1.5rem' }}>
              <li><strong>Variable lengths:</strong> Some networks (Visa, Maestro, UnionPay) support multiple lengths</li>
              <li><strong>BIN expansion:</strong> Mastercard expanded to 2221-2720 range due to 51-55 exhaustion</li>
              <li><strong>Future changes:</strong> Networks may add new prefixes or lengths over time</li>
              <li><strong>Testing cards:</strong> Use network-provided test cards, never real customer data</li>
            </ul>
          </div>
        </div>
      )}
      ...
      {activeTab === 'vcn' && (
        <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
          ...
          {/* VCN Structure */}
          <div style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: '#eff6ff', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
            <h3 style={{ fontSize: '1.4rem', fontWeight: '600', color: '#1f2937', marginBottom: '1rem' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              {/* Rule 1 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #3b82f6' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                    1. Luhn Algorithm Validation
                  </h4>
                  <code style={{ fontSize: '0.85rem', color: '#ef4444', backgroundColor: '#fef2f2', padding: '0.25rem 0.5rem', borderRadius: '4px' }}>
                    INVALID_VCN_CHECKSUM
                  </code>
                </div>
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> VCN position 16 (check digit) must be valid according to Luhn algorithm
                </p>
              </div>

              {/* Rule 2 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #10b981' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> VCN positions 1-6 must be in range 400000-499999 (Capital One Visa virtual cards)
                </p>
              </div>

              {/* Rule 3 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #f59e0b' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                    3. Card Status Check
                  </h4>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> VCN must be active (not expired, suspended, or closed)
                </p>
              </div>

              {/* Rule 4 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #a855f7' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> Transaction ID positions 3-6 (sequence number) cannot increment more than 5 times in 1 hour
                </p>
              </div>

              {/* Rule 5 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #ec4899' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> Transaction amount must not exceed VCN's remaining available credit limit
                </p>
              </div>

              {/* Rule 6 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #14b8a6' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> Transaction ID positions 1-2 must match one of the allowed merchant categories for this VCN
                </p>
              </div>

              {/* Rule 7 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #0ea5e9' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> Merchant location must be within allowed geographic regions for the VCN
                </p>
              </div>

              {/* Rule 8 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #8b5cf6' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> Transaction ID positions 3-6 must be greater than the last successful transaction sequence
                </p>
              </div>

              {/* Rule 9 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #f97316' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> Transaction ID positions 7-8 must match computed control digits: (sum of positions 1-6) mod 97
                </p>
              </div>

              {/* Rule 10 */}
              <div style={{ padding: '1.25rem', backgroundColor: '#f9fafb', borderRadius: '8px', borderLeft: '4px solid #ef4444' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem' }}>
                  <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: 0 }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.95rem', margin: 0 }}>
                  <strong>Rule:</strong> The complete 8-digit transaction ID must not have been used in the last 24 hours
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: '#fef3c7', borderRadius: '8px', borderLeft: '4px solid #f59e0b' }}>
            <h3 style={{ fontSize: '1.4rem', fontWeight: '600', color: '#1f2937', marginBottom: '1rem' }}>
              ⚖️ Processing Decision Logic
            </h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
              <div style={{ padding: '1rem', backgroundColor: '#f0fdf4', borderRadius: '6px', border: '2px solid #10b981' }}>
              ...
              <div style={{ padding: '1rem', backgroundColor: '#fef2f2', borderRadius: '6px', border: '2px solid #ef4444' }}>
              ...
              <div style={{ padding: '1rem', backgroundColor: '#fffbeb', borderRadius: '6px', border: '2px solid #f59e0b' }}>
              ...
              <div style={{ padding: '1rem', backgroundColor: '#fef2f2', borderRadius: '6px', border: '2px solid #f97316' }}>
          ...
          <div style={{ padding: '1.5rem', backgroundColor: '#fdf4ff', borderRadius: '8px', borderLeft: '4px solid #a855f7' }}>
            ...
            <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', marginBottom: '0.75rem' }}>
              Validation Steps:
            </h4>
            <div style={{ display: 'grid', gap: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 1 - Luhn Check:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>Checksum valid (digit 6 is correct)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 2 - IIN Range:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>453201 is in valid Capital One range (400000-499999)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 3 - Card Status:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>VCN is active (expires 12/2026)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 4 - Velocity:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>Only 2 transactions in last hour (limit: 5)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 5 - Spend Limit:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>Available credit: $500, Amount: $150 (OK)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 6 - MCC Whitelist:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>MCC 52 (Clothing Stores) is allowed for this VCN</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 7 - Geographic:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>Merchant in USA (allowed region)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 8 - Sequence:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>0012 &gt; last sequence 0011 (valid increment)</span>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', padding: '0.75rem', backgroundColor: 'white', borderRadius: '6px' }}>
                <span style={{ fontSize: '1.2rem' }}>✅</span>
                <div style={{ flex: 1 }}>
                  <strong style={{ color: '#1f2937' }}>Rule 9 - Control Digits:</strong>
                  <span style={{ color: '#6b7280', marginLeft: '0.5rem' }}>(5+2+0+0+1+2) mod 97 = 10, expected: 67 ❌ WAIT... let me recalculate: (52+00+12) = 64 mod 97 = 64, but we have 67... This would fail!</span>
                </div>
              </div>
            </div>

            <div style={{ marginTop: '1.5rem', padding: '1rem', backgroundColor: '#fef2f2', borderRadius: '6px', border: '2px solid #ef4444' }}>
              <div style={{ fontSize: '1.2rem', fontWeight: '700', color: '#ef4444', marginBottom: '0.5rem' }}>
                ❌ Decision: REJECT
              </div>
              <p style={{ color: '#4b5563', fontSize: '0.95rem', margin: 0 }}>
                <strong>Reason:</strong> Control digit validation failed (Rule 9). Expected 64, received 67.
                This is a critical rule failure indicating potential data corruption or fraudulent modification of the transaction ID.
              </p>
            </div>

            <div style={{ marginTop: '1rem', padding: '1rem', backgroundColor: '#f0fdf4', borderRadius: '6px', fontSize: '0.9rem', color: '#059669', fontStyle: 'italic' }}>
