...
function ActuatorQuestions({ onBack }) {
...
\`\`\``
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto', backgroundColor: '#fef3c7', minHeight: '100vh' }}>
      <div style={{
        display: 'flex',
        ...
        <h1 style={{
          ...
          ⚙️ Spring Boot Actuator Questions
        </h1>
