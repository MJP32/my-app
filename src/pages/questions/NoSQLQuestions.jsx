...
function NoSQLQuestions({ onBack, breadcrumb, problemLimit }) {
...
- Choose based on actual requirements, not hype`
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto', background: 'linear-gradient(to bottom right, #111827, #064e3b, #111827)', minHeight: '100vh' }}>
      <div style={{
        display: 'flex',
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <div onClick={(e) => e.stopPropagation()} style={{ transform: 'scale(0.85)' }}>
                  <CompletionCheckbox problemId={`NoSQLQuestions-${q.id}`} />
                </div>
                <div style={{
                  fontSize: '1.5rem',
