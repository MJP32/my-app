...
function Trees({ onBack, onPrevious, onNext, previousName, nextName, currentSubcategory, previousSubcategory, nextSubcategory, onPreviousSubcategory, onNextSubcategory }) {
...
def maxDepth_bfs(root):
    ...
    },
    {
      ...
      example: `Input: tree = [1,null,3,2,4,null,5,6]
Output: node with value 1

Explanation: The root is the node with value 1 as it has no parent.`,
      code: {
        java: {
          starterCode: `class Node {
    public int val;
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto', backgroundColor: '#f0f9ff', minHeight: '100vh' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: '800', color: '#1f2937', marginBottom: '0.5rem' }}>🌴 Trees</h1>
        <p style={{ fontSize: '1.2rem', color: '#6b7280' }}>Master trees problems</p>
