...
- If result = 214748364 and digit > 7, adding it overflows`,
  ...
  const getCompletionStats = () => {
    const completed = displayQuestions.filter(q => isProblemCompleted(`Bit Manipulation-${q.id}`)).length
