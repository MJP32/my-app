...
function TwoPointers({ onBack, onPrevious, onNext, previousName, nextName, currentSubcategory, previousSubcategory, nextSubcategory, onPreviousSubcategory, onNextSubcategory, breadcrumb }) {
  ...
  const questions = [
    {
      ...
      description: 'TODO: Copy from Strings.jsx - Given a string s, return true if it is a palindrome, otherwise return false. A palindrome is a string that reads the same forward and backward.',
      code: {
        java: {
          starterCode: `// TODO: Copy from existing file`,
          solution: `// TODO: Copy from existing file`
        },
        python: {
          starterCode: `# TODO: Copy from existing file`,
          solution: `# TODO: Copy from existing file`
      ...
      explanation: 'TODO: Copy from existing file',
      pseudocode: 'TODO: Copy from existing file'
    },
    {
      id: 2,
      ...
      description: 'TODO: Copy from Arrays.jsx',
      code: {
        java: {
          starterCode: `// TODO: Copy from existing file`,
          solution: `// TODO: Copy from existing file`
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto', backgroundColor: '#f0f9ff', minHeight: '100vh' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: '800', color: '#1f2937', marginBottom: '0.5rem' }}>👉👈 Two Pointers</h1>
        <p style={{ fontSize: '1.2rem', color: '#6b7280' }}>Master two pointers problems</p>
