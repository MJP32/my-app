...
function BinaryTrees({ onBack, onPrevious, onNext, previousName, nextName, currentSubcategory, previousSubcategory, nextSubcategory, onPreviousSubcategory, onNextSubcategory, breadcrumb, breadcrumbStack, onBreadcrumbClick, pushBreadcrumb, breadcrumbColors }) {
...
def zigzagLevelOrderDFS(self, root: Optional[TreeNode]) -> List[List[int]]:
  ...
  if (selectedQuestion) {
    ...
    const problemBreadcrumbStack = breadcrumbStack
      ? [...breadcrumbStack.slice(0, -1), { name: 'Binary Trees', page: null }, { name: selectedQuestion.title, page: null }]
      : null
