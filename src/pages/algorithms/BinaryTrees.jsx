...
def zigzagLevelOrderDFS(self, root: Optional[TreeNode]) -> List[List[int]]:
  ...
  const getCompletionStats = () => {
    const completed = displayQuestions.filter(q => isProblemCompleted(`Binary Trees-${q.id}`)).length
