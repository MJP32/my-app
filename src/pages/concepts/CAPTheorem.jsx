...
export default function CAPTheorem({ onBack, breadcrumb }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex gap-2 flex-wrap">
            <span className="px-4 py-2 bg-blue-900/30 text-blue-300 rounded-lg text-sm font-medium border border-blue-700">Consistency</span>
            <span className="px-4 py-2 bg-green-900/30 text-green-300 rounded-lg text-sm font-medium border border-green-700">Availability</span>
            <span className="px-4 py-2 bg-orange-900/30 text-orange-300 rounded-lg text-sm font-medium border border-orange-700">Partition Tolerance</span>
            <span className="px-4 py-2 bg-purple-900/30 text-purple-300 rounded-lg text-sm font-medium border border-purple-700">Trade-offs</span>
          </div>
        </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 rounded-2xl p-8 border-2 border-yellow-700">
              <h2 className="text-3xl font-bold text-white mb-6">Why Choose Only Two?</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-800 p-6 rounded-xl border border-yellow-700 shadow-sm">
                  <h3 className="text-lg font-bold text-yellow-400 mb-3">Choose Consistency</h3>
                  <p className="text-gray-300">Wait for the partition to resolve, potentially becoming unavailable. Some nodes may return errors.</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-yellow-700 shadow-sm">
                  <h3 className="text-lg font-bold text-yellow-400 mb-3">Choose Availability</h3>
                  <p className="text-gray-300">Continue serving requests from all nodes, risking that different nodes return different data.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'combinations' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 rounded-2xl p-8 border-2 border-blue-700">
              <h2 className="text-3xl font-bold text-white mb-6">CP - Consistency + Partition Tolerance</h2>
              <p className="text-gray-300 text-lg mb-4">Sacrifice availability to maintain consistency during partitions.</p>
              <div className="bg-gray-800 p-6 rounded-xl border border-blue-700 mb-4">
                <h3 className="font-bold text-blue-400 mb-3">Behavior:</h3>
                ...
                <h3 className="font-bold text-blue-400 mb-3">Use Cases:</h3>
            ...
            <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 rounded-2xl p-8 border-2 border-green-700">
              <h2 className="text-3xl font-bold text-white mb-6">AP - Availability + Partition Tolerance</h2>
              <p className="text-gray-300 text-lg mb-4">Sacrifice consistency to maintain availability during partitions.</p>
              <div className="bg-gray-800 p-6 rounded-xl border border-green-700 mb-4">
                <h3 className="font-bold text-green-400 mb-3">Behavior:</h3>
                <p className="text-gray-300 mb-4">
                ...
                <h3 className="font-bold text-green-400 mb-3">Use Cases:</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-green-900/30 p-6 rounded-xl border border-green-700">
                <h3 className="font-bold text-green-400 mb-3">Examples:</h3>
                <ul className="space-y-2 text-gray-300">
            ...
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-2xl p-8 border-2 border-purple-700">
              <h2 className="text-3xl font-bold text-white mb-6">CA - Consistency + Availability</h2>
              <p className="text-gray-300 text-lg mb-4">No partition tolerance - only possible in non-distributed systems.</p>
              <div className="bg-gray-800 p-6 rounded-xl border border-purple-700 mb-4">
                <h3 className="font-bold text-purple-400 mb-3">Reality Check:</h3>
                <p className="text-gray-300 mb-4">
                ...
                <h3 className="font-bold text-purple-400 mb-3">Practical Application:</h3>
                <p className="text-gray-300">
        ...
        {activeTab === 'theorem' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded-2xl p-8 border-2 border-orange-700">
              ...
              <div className="space-y-4">
                <div className="bg-gray-800 p-6 rounded-xl border border-orange-700">
                  <h3 className="font-bold text-red-400 mb-3">❌ "You can only have 2 out of 3 at all times"</h3>
                  <p className="text-gray-300 mb-2">Reality: During normal operations (no partition), you can have all three!</p>
                  <p className="text-sm text-gray-400">The choice only matters when a network partition occurs.</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-orange-700">
                  <h3 className="font-bold text-red-400 mb-3">❌ "CAP is binary - either 100% or 0%"</h3>
                  <p className="text-gray-300 mb-2">Reality: These properties exist on a spectrum with tunable trade-offs</p>
                  <p className="text-sm text-gray-400">You can tune consistency levels (eventual, strong, causal) and availability guarantees.</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-orange-700">
                  <h3 className="font-bold text-red-400 mb-3">❌ "Partition tolerance is optional"</h3>
                  <p className="text-gray-300 mb-2">Reality: In distributed systems, partitions will happen</p>
                  <p className="text-sm text-gray-400">You must build for partition tolerance. The real choice is between C and A during partitions.</p>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 rounded-2xl p-8 border-2 border-blue-700">
              <h2 className="text-3xl font-bold text-white mb-6">Modern Perspective: PACELC</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-800 p-6 rounded-xl border border-blue-700">
                  <h3 className="font-bold text-blue-400 mb-3">During Partition (P)</h3>
                  <p className="text-gray-300">Choose between Availability (A) or Consistency (C)</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-blue-700">
                  <h3 className="font-bold text-blue-400 mb-3">During Normal Operation (E)</h3>
                  <p className="text-gray-300">Choose between Latency (L) or Consistency (C)</p>
                </div>
              </div>
              <div className="mt-6 bg-blue-900/30 p-6 rounded-xl border border-blue-700">
                <h3 className="font-bold text-blue-400 mb-3">Examples:</h3>
                <ul className="space-y-2 text-gray-300">
            ...
            <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 rounded-2xl p-8 border-2 border-green-700">
              <h2 className="text-3xl font-bold text-white mb-6">Tunable Consistency</h2>
              <p className="text-gray-300 text-lg mb-6">
              ...
              <div className="space-y-3">
                <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                  <h3 className="font-bold text-green-400 mb-2">Strong Consistency (Linearizability)</h3>
                  <p className="text-gray-300 text-sm">All reads see the most recent write. Highest consistency, lowest availability.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                  <h3 className="font-bold text-green-400 mb-2">Causal Consistency</h3>
                  <p className="text-gray-300 text-sm">Causally related operations are seen in order. Balance between strong and eventual.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                  <h3 className="font-bold text-green-400 mb-2">Eventual Consistency</h3>
                  <p className="text-gray-300 text-sm">Given enough time without updates, all replicas converge. Highest availability.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                  <h3 className="font-bold text-green-400 mb-2">Read-Your-Writes</h3>
                  <p className="text-gray-300 text-sm">A user sees their own writes immediately, but others may see them later.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'examples' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-2xl p-8 border-2 border-purple-700">
              <h2 className="text-3xl font-bold text-white mb-6">Real-World CAP Decisions</h2>
              <div className="space-y-4">
                <div className="bg-gray-800 p-6 rounded-xl border border-purple-700">
                  <h3 className="font-bold text-purple-400 text-xl mb-2">Banking System (CP)</h3>
                  ...
                  <span className="text-sm text-gray-400">Sacrifice: May be unavailable during network partitions</span>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-purple-700">
                  <h3 className="font-bold text-purple-400 text-xl mb-2">Social Media Feed (AP)</h3>
                  <p className="text-gray-300 mb-2">
                  ...
                  <span className="text-sm text-gray-400">Sacrifice: Users may see stale data during network issues</span>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-purple-700">
                  <h3 className="font-bold text-purple-400 text-xl mb-2">DNS System (AP)</h3>
                  <p className="text-gray-300 mb-2">
                  ...
                  <span className="text-sm text-gray-400">Sacrifice: DNS changes take time to propagate globally</span>
                </div>
                <div className="bg-gray-800 p-6 rounded-xl border border-purple-700">
                  <h3 className="font-bold text-purple-400 text-xl mb-2">Shopping Cart (AP → CP)</h3>
                  <p className="text-gray-300 mb-2">
                  ...
                  <span className="text-sm text-gray-400">Hybrid approach: different guarantees for different operations</span>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 rounded-2xl p-8 border-2 border-blue-700">
              <h2 className="text-3xl font-bold text-white mb-6">Database Categorization</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h3 className="text-xl font-bold text-blue-400">CP Systems</h3>
                  <div className="bg-gray-800 p-4 rounded-xl border border-blue-700">
                    <p className="font-bold text-white">MongoDB</p>
                    <p className="text-sm text-gray-400">With majority write concern</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-xl border border-blue-700">
                    <p className="font-bold text-white">HBase</p>
                    <p className="text-sm text-gray-400">Strong consistency model</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-xl border border-blue-700">
                    <p className="font-bold text-white">Redis</p>
                    <p className="text-sm text-gray-400">With AOF and sync replication</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-xl border border-blue-700">
                    <p className="font-bold text-white">ZooKeeper</p>
                    <p className="text-sm text-gray-400">Consensus-based coordination</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <h3 className="text-xl font-bold text-green-400">AP Systems</h3>
                  <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                    <p className="font-bold text-white">Cassandra</p>
                    <p className="text-sm text-gray-400">Always available, eventually consistent</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                    <p className="font-bold text-white">DynamoDB</p>
                    <p className="text-sm text-gray-400">Highly available key-value store</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                    <p className="font-bold text-white">CouchDB</p>
                    <p className="text-sm text-gray-400">Multi-master replication</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-xl border border-green-700">
                    <p className="font-bold text-white">Riak</p>
                    <p className="text-sm text-gray-400">Distributed with eventual consistency</p>
                  </div>
                </div>
              </div>
            </div>
