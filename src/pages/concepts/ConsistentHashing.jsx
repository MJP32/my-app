...
export default function ConsistentHashing({ onBack }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-lg text-xs font-bold uppercase tracking-wide">
              Core Concept
            </span>
          </div>
          ...
          <div className="flex gap-2 flex-wrap">
            <span className="px-4 py-2 bg-yellow-50 text-yellow-700 rounded-lg text-sm font-medium border border-yellow-100">Hash Ring</span>
            <span className="px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium border border-blue-100">Virtual Nodes</span>
            <span className="px-4 py-2 bg-green-50 text-green-700 rounded-lg text-sm font-medium border border-green-100">Minimal Remapping</span>
            <span className="px-4 py-2 bg-purple-50 text-purple-700 rounded-lg text-sm font-medium border border-purple-100">Scalability</span>
          </div>
        </div>
          ...
          {['overview', 'algorithm', 'virtual-nodes', 'examples'].map(tab => (
            <button
              ...
              className={`px-6 py-3 font-semibold transition-all whitespace-nowrap rounded-t-lg ${
                activeTab === tab
                  ? 'text-yellow-600 bg-yellow-50 border-b-2 border-yellow-600 -mb-0.5'
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 border-2 border-yellow-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">What is Consistent Hashing?</h2>
            ...
            <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-8 border-2 border-red-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">The Problem with Simple Hashing</h2>
              <div className="bg-white p-6 rounded-xl border border-red-100 mb-4">
                <h3 className="font-bold text-red-700 mb-3">Simple Hash Formula:</h3>
                <code className="bg-red-50 px-4 py-2 rounded block mb-4">server = hash(key) % N</code>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl border border-blue-100 shadow-sm">
                  <h3 className="text-lg font-bold text-blue-700 mb-3">🔄 Minimal Remapping</h3>
                  <p className="text-gray-700">Only K/N keys remapped on average (K=keys, N=nodes)</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100 shadow-sm">
                  <h3 className="text-lg font-bold text-blue-700 mb-3">📈 Scalability</h3>
                  <p className="text-gray-700">Add/remove servers with minimal disruption</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100 shadow-sm">
                  <h3 className="text-lg font-bold text-blue-700 mb-3">⚖️ Load Balance</h3>
                  <p className="text-gray-700">Virtual nodes ensure even distribution</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100 shadow-sm">
                  <h3 className="text-lg font-bold text-blue-700 mb-3">💪 Fault Tolerance</h3>
                  <p className="text-gray-700">System continues with failed nodes</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'algorithm' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">The Hash Ring</h2>
              ...
              <div className="bg-white p-6 rounded-xl border border-purple-100">
                <h3 className="font-bold text-purple-700 mb-4">Algorithm:</h3>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Adding a Node</h2>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Removing a Node</h2>
              <p className="text-gray-700 mb-4">
        ...
        {activeTab === 'virtual-nodes' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 border-2 border-orange-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Virtual Nodes?</h2>
              ...
              <div className="bg-white p-6 rounded-xl border border-orange-100">
                <h3 className="font-bold text-orange-700 mb-3">Problem:</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Virtual Nodes Solution</h2>
              <p className="text-gray-700 text-lg mb-4">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Weighted Virtual Nodes</h2>
              <p className="text-gray-700 text-lg mb-4">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              ...
              <div className="space-y-4">
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 text-xl mb-2">Amazon DynamoDB</h3>
                  <p className="text-gray-700 mb-2">Uses consistent hashing to partition data across nodes</p>
                  <span className="text-sm text-gray-500">Automatic rebalancing when nodes added/removed</span>
                </div>
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 text-xl mb-2">Apache Cassandra</h3>
                  <p className="text-gray-700 mb-2">Built-in consistent hashing with virtual nodes</p>
                  <span className="text-sm text-gray-500">Vnodes for even distribution</span>
                </div>
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 text-xl mb-2">Memcached Clients</h3>
                  <p className="text-gray-700 mb-2">Client libraries use consistent hashing for cache distribution</p>
                  <span className="text-sm text-gray-500">Minimal cache invalidation on scaling</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              ...
              <div className="space-y-4">
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 mb-2">💾 Distributed Caching</h3>
                  <p className="text-gray-700">Distribute cache keys across multiple cache servers</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 mb-2">🗄️ Database Sharding</h3>
                  <p className="text-gray-700">Partition data across database shards efficiently</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 mb-2">⚖️ Load Balancing</h3>
                  <p className="text-gray-700">Distribute requests with session affinity</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 mb-2">📦 Object Storage</h3>
                  <p className="text-gray-700">Distribute files across storage nodes</p>
                </div>
              </div>
            </div>
          </div>
