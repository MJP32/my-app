...
export default function WebSockets({ onBack }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex gap-2 flex-wrap">
            <span className="px-4 py-2 bg-green-50 text-green-700 rounded-lg text-sm font-medium border border-green-100">WebSockets</span>
            <span className="px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium border border-blue-100">Long Polling</span>
            <span className="px-4 py-2 bg-purple-50 text-purple-700 rounded-lg text-sm font-medium border border-purple-100">SSE</span>
            <span className="px-4 py-2 bg-orange-50 text-orange-700 rounded-lg text-sm font-medium border border-orange-100">Real-time</span>
          </div>
        </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">🔌 WebSockets</h2>
              ...
              <div className="bg-white p-6 rounded-xl border border-green-100">
                <h3 className="font-bold text-green-700 mb-3">Key Features:</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">🔄 Long Polling</h2>
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">📡 Server-Sent Events (SSE)</h2>
              <p className="text-gray-700 text-lg leading-relaxed mb-4">
          ...
          <div className="space-y-8">
                ...
                <table className="w-full bg-white rounded-xl border border-gray-200">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th className="p-4 text-left font-bold text-green-700">WebSockets</th>
                      <th className="p-4 text-left font-bold text-blue-700">Long Polling</th>
                      <th className="p-4 text-left font-bold text-purple-700">SSE</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      <td className="p-4 font-semibold">Communication</td>
                      <td className="p-4 text-gray-700">Bidirectional</td>
                      <td className="p-4 text-gray-700">Bidirectional</td>
                      <td className="p-4 text-gray-700">Unidirectional (S→C)</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="p-4 font-semibold">Protocol</td>
                      <td className="p-4 text-gray-700">ws:// / wss://</td>
                      <td className="p-4 text-gray-700">HTTP/HTTPS</td>
                      <td className="p-4 text-gray-700">HTTP/HTTPS</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold">Latency</td>
                    ...
                    <tr className="bg-gray-50">
                      <td className="p-4 font-semibold">Overhead</td>
                      <td className="p-4 text-green-600 font-bold">Minimal</td>
                      <td className="p-4 text-red-600">High</td>
                      <td className="p-4 text-green-600">Low</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold">Browser Support</td>
                      <td className="p-4 text-gray-700">Modern browsers</td>
                      <td className="p-4 text-green-600 font-bold">All browsers</td>
                      <td className="p-4 text-gray-700">Most modern browsers</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="p-4 font-semibold">Firewall/Proxy</td>
                      <td className="p-4 text-yellow-600">May be blocked</td>
                      <td className="p-4 text-green-600 font-bold">Works everywhere</td>
                      <td className="p-4 text-green-600">Works well</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-semibold">Complexity</td>
                      <td className="p-4 text-yellow-600">Moderate</td>
                      <td className="p-4 text-green-600">Simple</td>
                      <td className="p-4 text-green-600 font-bold">Very Simple</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="p-4 font-semibold">Best Use Case</td>
                      <td className="p-4 text-gray-700">Chat, gaming, collaboration</td>
                      <td className="p-4 text-gray-700">Fallback, simple updates</td>
                      <td className="p-4 text-gray-700">Notifications, feeds</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 text-xl mb-4">Use WebSockets</h3>
                ...
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 text-xl mb-4">Use Long Polling</h3>
                  <ul className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-white p-6 rounded-xl border border-purple-100">
                  <h3 className="font-bold text-purple-700 text-xl mb-4">Use SSE</h3>
                  <ul className="space-y-2 text-gray-700 text-sm">
        ...
        {activeTab === 'implementation' && (
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">WebSocket Implementation</h2>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Long Polling Implementation</h2>
              <div className="bg-gray-900 p-6 rounded-xl text-white font-mono text-sm mb-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">SSE Implementation</h2>
              <div className="bg-gray-900 p-6 rounded-xl text-white font-mono text-sm mb-4">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-200">
              ...
              <div className="space-y-4">
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 mb-2">💬 Slack - Team Chat (WebSockets)</h3>
                  <p className="text-gray-700">Uses WebSockets for instant message delivery, typing indicators, and presence updates across millions of concurrent connections</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 mb-2">📝 Google Docs - Collaborative Editing (WebSockets)</h3>
                  <p className="text-gray-700">Real-time document synchronization using WebSockets with operational transformation for conflict resolution</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-green-100">
                  <h3 className="font-bold text-green-700 mb-2">📊 Trading Platforms (WebSockets)</h3>
                  <p className="text-gray-700">Stock/crypto exchanges push real-time price updates with microsecond latency for high-frequency trading</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 mb-2">📧 Gmail - Email Notifications (Long Polling)</h3>
                  <p className="text-gray-700">Originally used long polling for new email notifications before adopting more modern approaches</p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-purple-100">
                  <h3 className="font-bold text-purple-700 mb-2">🐦 Twitter/X - Live Feed Updates (SSE)</h3>
                  <p className="text-gray-700">Streams new tweets and notifications from server to client using Server-Sent Events</p>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border-2 border-blue-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Popular Libraries & Tools</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 text-xl mb-2">Socket.IO</h3>
                  <p className="text-gray-700 mb-2">JavaScript library for real-time web applications with automatic fallback support</p>
                  <span className="text-sm text-gray-500">WebSockets + Long Polling fallback</span>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 text-xl mb-2">SignalR (Microsoft)</h3>
                  <p className="text-gray-700 mb-2">ASP.NET library for adding real-time functionality</p>
                  <span className="text-sm text-gray-500">Automatic transport selection</span>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 text-xl mb-2">Pusher / Ably</h3>
                  <p className="text-gray-700 mb-2">Managed real-time messaging services</p>
                  <span className="text-sm text-gray-500">WebSockets as a Service</span>
                </div>
                <div className="bg-white p-6 rounded-xl border border-blue-100">
                  <h3 className="font-bold text-blue-700 text-xl mb-2">Centrifugo</h3>
                  <p className="text-gray-700 mb-2">Scalable real-time messaging server</p>
                  <span className="text-sm text-gray-500">Language-agnostic WebSocket server</span>
                </div>
              </div>
            </div>
          </div>
