    ...
    <div style={{ padding: '1.5rem', maxWidth: '1400px', margin: '0 auto', backgroundColor: '#fff1f2', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        {[
          ...
          { id: 'routing', label: 'Driver Routing', icon: '🗺️' },
      ...
      <div style={{
        ...
        {activeTab === 'architecture' && (
          <div className="space-y-6">
            ...
            <div className="mt-8 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-200">
              <h3 className="text-2xl font-bold mb-4 text-yellow-800">🎨 Key Components</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📍 Location Service</div>
        ...
        {activeTab === 'matching' && (
          <div className="space-y-6">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">🎯 Order-Driver Matching Algorithm</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 shadow-xl border-2 border-blue-400 max-w-3xl w-full">
                  <div className="text-white">
                    <div className="text-xl font-bold mb-2">1️⃣ Customer Places Order</div>
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 shadow-xl border-2 border-green-400 max-w-3xl w-full">
                  <div className="text-white">
                    <div className="text-xl font-bold mb-2">2️⃣ Find Nearby Available Drivers</div>
                ...
                <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl p-6 shadow-xl border-2 border-yellow-400 max-w-3xl w-full">
                  <div className="text-white">
                    <div className="text-xl font-bold mb-2">3️⃣ Calculate Match Score</div>
                    <div className="text-sm text-yellow-100">
                      Score = w1×Distance + w2×ETA + w3×Rating + w4×AcceptanceRate
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 shadow-xl border-2 border-orange-400 max-w-3xl w-full">
                  <div className="text-white">
                    <div className="text-xl font-bold mb-2">4️⃣ Send to Top 5 Drivers (Batch)</div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 shadow-xl border-2 border-purple-400 max-w-3xl w-full">
                  <div className="text-white text-center">
                    <div className="text-xl font-bold mb-2">5️⃣ First Acceptance Wins</div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 border-2 border-pink-200">
              <h3 className="text-2xl font-bold mb-4 text-pink-800">🧮 Matching Score Formula</h3>
              <div className="space-y-4">
                <div className="bg-white rounded-lg p-4 shadow">
...
{`Driver A:
  Distance: 2km → score = (5-2)/5 × 100 = 60
  ETA: 8 min → score = (20-8)/20 × 100 = 60
  Rating: 4.8/5 → score = 4.8/5 × 100 = 96
  Accept Rate: 85% → score = 85

Total Score = 0.4×60 + 0.3×60 + 0.2×96 + 0.1×85
            = 24 + 18 + 19.2 + 8.5 = 69.7`}
                  </pre>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-2 border-red-200">
              <h3 className="text-2xl font-bold mb-4 text-red-800">📍 Redis Geospatial Queries</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
        ...
        {activeTab === 'routing' && (
          <div className="space-y-6">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">🗺️ Driver Routing & Navigation</h2>
            ...
            {/* Routing APIs */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">🛣️ Routing APIs</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🗺️ Google Maps Directions API</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🚗 OSRM (Open Source Routing Machine)</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📍 Mapbox Directions</div>
                  <div className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border-2 border-orange-200">
              <h3 className="text-2xl font-bold mb-4 text-orange-800">⏱️ ETA Calculation</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
        ...
        {activeTab === 'features' && (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-200">
              <h3 className="text-2xl font-bold mb-4 text-purple-800">💰 Dynamic Pricing (Surge Pricing)</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  ...
                  <code className="text-xs bg-gray-100 p-2 rounded block">
                    Multiplier = 1.0 + (DemandScore × 0.5) + (SupplyScore × 0.3) + (WeatherScore × 0.2)
                  </code>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">🔍 Restaurant Discovery</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-200">
              <h3 className="text-2xl font-bold mb-4 text-yellow-800">💳 Payment Processing</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
        ...
        {activeTab === 'scalability' && (
          <div className="space-y-6">
            ...
            {/* Database Scaling */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
              <h3 className="text-2xl font-bold mb-4 text-blue-800">🗄️ Database Scaling</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📊 Sharding Strategy</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">⚡ Redis for Hot Data</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Geospatial Scaling */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">📍 Geospatial Data Scaling</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-200">
              <h3 className="text-2xl font-bold mb-4 text-purple-800">🚀 Performance Optimization</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">⚡ CDN for Static Assets</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🔄 Async Processing</div>
                  <div className="text-sm text-gray-600">
        ...
        {activeTab === 'api' && (
          <div className="space-y-6">
            {/* API Overview */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-2 border-red-200">
              <h2 className="text-2xl font-bold mb-4 text-red-800">🔌 Food Delivery API Overview</h2>
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">🍽️ Restaurant & Menu APIs</h3>
      ...
      "items": [
        {
          ...
          "available": true
            ...
            {/* Order APIs */}
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">📦 Order APIs</h3>
...
{`{
  ...
  "estimated_delivery": "2024-01-20T12:35:00Z"
            ...
            {/* Driver APIs */}
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">🚗 Driver APIs</h3>
...
{`{
  ...
  "speed": 25
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">📍 Tracking & Payment APIs</h3>
