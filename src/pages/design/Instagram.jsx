...
export default function Instagram({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8 bg-white rounded-2xl shadow-lg p-6 border-l-8 border-pink-500">
          ...
          {tabs.map(tab => (
            <button
              ...
              className={`px-6 py-3 font-semibold transition-all whitespace-nowrap rounded-t-lg ${
                activeTab === tab.id
                  ? 'text-pink-600 bg-pink-50 border-b-4 border-pink-600 -mb-0.5'
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-purple-500">
              ...
              <div className="mt-6 grid md:grid-cols-3 gap-4">
                <div className="bg-pink-50 p-4 rounded-lg border-l-4 border-pink-500">
                  <div className="font-bold text-pink-900 mb-2">Client Layer</div>
                  <div className="text-sm text-pink-800">Mobile and web apps with CDN for fast media delivery</div>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500">
                  <div className="font-bold text-purple-900 mb-2">Service Layer</div>
                  <div className="text-sm text-purple-800">Microservices for upload, feed, users, stories, search</div>
                </div>
                <div className="bg-indigo-50 p-4 rounded-lg border-l-4 border-indigo-500">
                  <div className="font-bold text-indigo-900 mb-2">Data Layer</div>
                  <div className="text-sm text-indigo-800">Distributed databases with S3 for images and Redis for caching</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-emerald-500">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl border-2 border-purple-200">
                  <h3 className="font-bold text-purple-900 mb-4 text-lg">Traffic Estimates</h3>
                  <div className="space-y-2 text-gray-700">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-xl border-2 border-orange-200">
                  <h3 className="font-bold text-orange-900 mb-4 text-lg">Bandwidth Requirements</h3>
                  <div className="space-y-2 text-gray-700">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-indigo-500">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-indigo-50 p-6 rounded-xl border-l-4 border-indigo-500">
                  <h3 className="font-bold text-indigo-900 mb-3 text-lg">Image Processing Pipeline</h3>
                ...
                <div className="bg-pink-50 p-6 rounded-xl border-l-4 border-pink-500">
                  <h3 className="font-bold text-pink-900 mb-3 text-lg">Feed Ranking Algorithm</h3>
                  <div className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                  <h3 className="font-bold text-green-900 mb-3 text-lg">Stories Architecture</h3>
                  <div className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-yellow-50 p-6 rounded-xl border-l-4 border-yellow-500">
                  <h3 className="font-bold text-yellow-900 mb-3 text-lg">Follow Graph Management</h3>
                  <div className="space-y-2 text-gray-700 text-sm">
          ...
          <div className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-green-50 p-3 rounded-lg">
                    <div className="font-semibold text-green-900 mb-1">Upload Flow</div>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <div className="font-semibold text-blue-900 mb-1">Image Processing</div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-orange-50 p-3 rounded-lg">
                    <div className="font-semibold text-orange-900 mb-1">Feed Generation</div>
                  ...
                  <div className="bg-red-50 p-3 rounded-lg">
                    <div className="font-semibold text-red-900 mb-1">Fan-out Strategy</div>
                  ...
                  <div className="bg-pink-50 p-3 rounded-lg">
                    <div className="font-semibold text-pink-900 mb-1">Ranking Signals</div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-pink-500 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-pink-50 p-3 rounded-lg">
                    <div className="font-semibold text-pink-900 mb-1">Story Upload</div>
                  ...
                  <div className="bg-purple-50 p-3 rounded-lg">
                    <div className="font-semibold text-purple-900 mb-1">Story Retrieval</div>
                  ...
                  <div className="bg-yellow-50 p-3 rounded-lg">
                    <div className="font-semibold text-yellow-900 mb-1">Expiration & Cleanup</div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <div className="font-semibold text-blue-900 mb-1">User Management</div>
                  ...
                  <div className="bg-indigo-50 p-3 rounded-lg">
                    <div className="font-semibold text-indigo-900 mb-1">Social Graph</div>
                  ...
                  <div className="bg-cyan-50 p-3 rounded-lg">
                    <div className="font-semibold text-cyan-900 mb-1">User Discovery</div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-purple-50 p-3 rounded-lg">
                    <div className="font-semibold text-purple-900 mb-1">Search Types</div>
                  ...
                  <div className="bg-pink-50 p-3 rounded-lg">
                    <div className="font-semibold text-pink-900 mb-1">Explore Page</div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-cyan-500 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="bg-cyan-50 p-3 rounded-lg">
                    <div className="font-semibold text-cyan-900 mb-1">Notification Types</div>
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg">
                    <div className="font-semibold text-teal-900 mb-1">Delivery Channels</div>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <div className="font-semibold text-blue-900 mb-1">Optimizations</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-pink-500">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h3 className="font-bold text-pink-900 text-lg mb-3">Story Upload</h3>
                  {[
                    ...
                    <div key={item.step} className={`bg-${item.color}-50 p-4 rounded-lg border-l-4 border-${item.color}-500`}>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <div className={`font-bold text-${item.color}-900 text-sm mb-1`}>{item.title}</div>
                ...
                <div className="space-y-3">
                  <h3 className="font-bold text-indigo-900 text-lg mb-3">Story Viewing</h3>
                  {[
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-purple-500">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-purple-50 p-6 rounded-xl border-2 border-purple-200">
                  <h3 className="font-bold text-purple-900 mb-3">Post Data Sharding (Cassandra)</h3>
                  <div className="space-y-2 text-gray-700">
                ...
                <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200">
                  <h3 className="font-bold text-blue-900 mb-3">User Data Sharding (PostgreSQL)</h3>
                  <div className="space-y-2 text-gray-700">
                ...
                <div className="bg-green-50 p-6 rounded-xl border-2 border-green-200">
                  <h3 className="font-bold text-green-900 mb-3">Graph Data (Neo4j)</h3>
                  <div className="space-y-2 text-gray-700">
                ...
                <div className="bg-orange-50 p-6 rounded-xl border-2 border-orange-200">
                  <h3 className="font-bold text-orange-900 mb-3">Object Storage (S3)</h3>
                  <div className="space-y-2 text-gray-700">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-cyan-500">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                  <div className="font-bold text-blue-900 mb-3 text-lg">L2: Redis Cache (Application)</div>
                  <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-700">
                ...
                <div className="bg-purple-50 p-6 rounded-xl border-l-4 border-purple-500">
                  <div className="font-bold text-purple-900 mb-3 text-lg">L3: In-Memory Cache (Service)</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-orange-500">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-orange-50 p-6 rounded-xl border-2 border-orange-200">
                  <h3 className="font-bold text-orange-900 mb-3">Global LB</h3>
                  <div className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200">
                  <h3 className="font-bold text-blue-900 mb-3">Regional LB</h3>
                  <div className="space-y-2 text-gray-700 text-sm">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-green-500">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-green-50 p-6 rounded-xl">
                  <div className="font-bold text-green-900 mb-3 text-lg">Image Optimizations</div>
                  <div className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-blue-50 p-6 rounded-xl">
                  <div className="font-bold text-blue-900 mb-3 text-lg">Feed Optimizations</div>
                  <div className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-purple-50 p-6 rounded-xl">
                  <div className="font-bold text-purple-900 mb-3 text-lg">API Optimizations</div>
                  <div className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="bg-orange-50 p-6 rounded-xl">
                  <div className="font-bold text-orange-900 mb-3 text-lg">Monitoring</div>
                  <div className="space-y-2 text-gray-700 text-sm">
          ...
          <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-indigo-50 p-6 rounded-xl border-2 border-indigo-200">
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      <div className="font-semibold text-gray-900">API: Python (Django) / Node.js</div>
                      <div className="text-gray-700">Fast development, rich ecosystem for image processing</div>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">Message Queue: Kafka</div>
                      <div className="text-gray-700">High throughput for async image processing</div>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">Image Processing: Python (Pillow/OpenCV)</div>
                      <div className="text-gray-700">Rich library support for image manipulation</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200">
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      <div className="font-semibold text-gray-900">Posts: Cassandra</div>
                      <div className="text-gray-700">Write-optimized, horizontal scaling for posts</div>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">Users: PostgreSQL</div>
                      <div className="text-gray-700">ACID compliance for user accounts</div>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">Graph: Neo4j</div>
                      <div className="text-gray-700">Efficient follow relationship queries</div>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">Images: S3 + CloudFront CDN</div>
                      <div className="text-gray-700">Scalable object storage with edge delivery</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-orange-500">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-orange-50 p-6 rounded-xl border-l-4 border-orange-500">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-white p-4 rounded-lg border-2 border-green-200">
                      <div className="font-bold text-green-700 mb-2">Fan-out on Write</div>
                    ...
                    <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                      <div className="font-bold text-blue-700 mb-2">Fan-out on Read</div>
                      <div className="text-sm space-y-1 text-gray-700">
                        <div><strong>Pros:</strong></div>
                ...
                {/* SQL vs NoSQL */}
                <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                  <h3 className="text-xl font-bold text-blue-900 mb-4">2. SQL vs NoSQL for Post Storage</h3>

                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-white p-4 rounded-lg border-2 border-purple-200">
                      <div className="font-bold text-purple-700 mb-2">SQL (PostgreSQL)</div>
                      <div className="text-sm space-y-1 text-gray-700">
                        <div><strong>Pros:</strong></div>
                  ...
                  <div className="bg-cyan-100 p-4 rounded-lg border-2 border-cyan-300">
                    <div className="font-bold text-cyan-900 mb-2">🎯 Our Decision: Cassandra for Posts</div>
                    <div className="text-sm text-gray-800">
                ...
                {/* Image Storage */}
                <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                  <h3 className="text-xl font-bold text-green-900 mb-4">3. Database Blob Storage vs Object Storage (S3)</h3>

                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                      <div className="font-bold text-blue-700 mb-2">Database Blob Storage</div>
                      <div className="text-sm space-y-1 text-gray-700">
                        <div><strong>Pros:</strong></div>
                    ...
                    <div className="bg-white p-4 rounded-lg border-2 border-green-200">
                      <div className="font-bold text-green-700 mb-2">Object Storage (S3)</div>
                      <div className="text-sm space-y-1 text-gray-700">
                        <div><strong>Pros:</strong></div>
                  ...
                  <div className="bg-emerald-100 p-4 rounded-lg border-2 border-emerald-300">
                    <div className="font-bold text-emerald-900 mb-2">🎯 Our Decision: S3 + CDN</div>
                    <div className="text-sm text-gray-800">
                ...
                {/* Stories Storage */}
                <div className="bg-purple-50 p-6 rounded-xl border-l-4 border-purple-500">
                  <h3 className="text-xl font-bold text-purple-900 mb-4">4. Stories: Database vs In-Memory (Redis)</h3>

                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-white p-4 rounded-lg border-2 border-blue-200">
                      <div className="font-bold text-blue-700 mb-2">Database Storage</div>
                      <div className="text-sm space-y-1 text-gray-700">
                        <div><strong>Pros:</strong></div>
                    ...
                    <div className="bg-white p-4 rounded-lg border-2 border-pink-200">
                      <div className="font-bold text-pink-700 mb-2">Redis (In-Memory)</div>
                      <div className="text-sm space-y-1 text-gray-700">
                        <div><strong>Pros:</strong></div>
                  ...
                  <div className="bg-violet-100 p-4 rounded-lg border-2 border-violet-300">
                    <div className="font-bold text-violet-900 mb-2">🎯 Our Decision: Redis + S3 Hybrid</div>
                    <div className="text-sm text-gray-800">
