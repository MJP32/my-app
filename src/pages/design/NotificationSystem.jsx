...
function NotificationSystem({ onBack }) {
  const [activeTab, setActiveTab] = useState('overview')

  return (
    <div style={{ padding: '1.5rem', maxWidth: '1400px', margin: '0 auto', backgroundColor: '#fff8e6', minHeight: '100vh' }}>
      {/* Header */}
      <div style={{
        display: 'flex',
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              fontSize: '0.9rem',
              fontWeight: '600',
              backgroundColor: activeTab === tab.id ? '#f59e0b' : '#f3f4f6',
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-yellow-50 rounded-xl p-6 border-2 border-yellow-200">
              <h3 className="text-2xl font-bold mb-4 text-yellow-800">📊 Scale & Metrics</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <div className="text-3xl font-bold text-yellow-600 mb-1">10M+</div>
                  <div className="text-sm text-gray-600">Notifications per second (peak)</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <div className="text-3xl font-bold text-yellow-600 mb-1">100B+</div>
                  <div className="text-sm text-gray-600">Notifications per day</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <div className="text-3xl font-bold text-yellow-600 mb-1">500M</div>
                  <div className="text-sm text-gray-600">Active users</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <div className="text-3xl font-bold text-yellow-600 mb-1">{'<'} 1 sec</div>
                  <div className="text-sm text-gray-600">Push notification latency (p95)</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <div className="text-3xl font-bold text-yellow-600 mb-1">99.9%</div>
                  <div className="text-sm text-gray-600">Delivery success rate</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-md">
                  <div className="text-3xl font-bold text-yellow-600 mb-1">3 channels</div>
                  <div className="text-sm text-gray-600">Push, Email, SMS</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">⚙️ Non-Functional Requirements</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <ul className="space-y-2 text-gray-700">
        ...
        {activeTab === 'architecture' && (
          <div className="space-y-6">
            ...
            <div className="mt-8 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-200">
              <h3 className="text-2xl font-bold mb-4 text-yellow-800">📝 API Example</h3>
              <div className="bg-white rounded-lg p-4 shadow font-mono text-sm">
...
{`{
  ...
  "ttl": 86400
        ...
        {activeTab === 'channels' && (
          <div className="space-y-6">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">📡 Notification Channels</h2>

            {/* Push Notifications */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
              <h3 className="text-2xl font-bold mb-4 text-blue-800">📱 Push Notifications</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🍎 iOS - APNs (Apple Push Notification service)</div>
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🤖 Android - FCM (Firebase Cloud Messaging)</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🌐 Web Push - Service Workers</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🔔 Device Token Management</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Email Notifications */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">📧 Email Notifications</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📮 Email Service Providers</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📝 Template Engine</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📊 Email Analytics</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🛡️ Deliverability</div>
                  <div className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-200">
              <h3 className="text-2xl font-bold mb-4 text-purple-800">💬 SMS Notifications</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📱 SMS Gateways</div>
                  <div className="text-sm text-gray-600">
...
ly (max 5 SMS/day per user)
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🌍 International Support</div>
                  <div className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border-2 border-orange-200">
              <h3 className="text-2xl font-bold mb-4 text-orange-800">⚙️ User Notification Preferences</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🎛️ Granular Controls</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🔕 Opt-out Management</div>
                  <div className="text-sm text-gray-600">
        ...
        {activeTab === 'reliability' && (
          <div className="space-y-6">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">🛡️ Reliability & Delivery Guarantees</h2>

            {/* Delivery Guarantees */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
              <h3 className="text-2xl font-bold mb-4 text-blue-800">✅ At-Least-Once Delivery</h3>
              <div className="space-y-3">
                <p className="text-gray-700">
                  We guarantee at-least-once delivery (not exactly-once) to balance reliability and cost:
                </p>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">1️⃣ Kafka Message Queue</div>
                  <div className="text-sm text-gray-600">Messages persisted to disk, not lost even if consumer crashes</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">2️⃣ Worker Acknowledgment</div>
                  <div className="text-sm text-gray-600">Worker commits offset only after successful delivery to provider</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">3️⃣ Retry Logic</div>
                  <div className="text-sm text-gray-600">Exponential backoff: 1s, 2s, 4s, 8s, 16s, 32s, 64s (max 7 retries)</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">4️⃣ Dead Letter Queue (DLQ)</div>
                  <div className="text-sm text-gray-600">After max retries, move to DLQ for manual investigation</div>
                </div>
              </div>
            </div>
            ...
            {/* Idempotency */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">🔁 Idempotency & Deduplication</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🆔 Notification ID</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">✅ Duplicate Detection</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📦 Batching</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Priority Handling */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-200">
              <h3 className="text-2xl font-bold mb-4 text-purple-800">⚡ Priority Levels</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow border-2 border-red-400">
                  <div className="font-bold text-gray-800 mb-2">🚨 Urgent (P0)</div>
                  <div className="text-sm text-gray-600">
                    Security alerts, fraud detection, system outages<br/>
                    <strong>Latency:</strong> {'<'} 100ms | <strong>Retry:</strong> Aggressive
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow border-2 border-orange-400">
                  <div className="font-bold text-gray-800 mb-2">⚠️ High (P1)</div>
                  <div className="text-sm text-gray-600">
                    Order updates, payment confirmations, 2FA codes<br/>
                    <strong>Latency:</strong> {'<'} 1 sec | <strong>Retry:</strong> Normal
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow border-2 border-blue-400">
                  <div className="font-bold text-gray-800 mb-2">📊 Normal (P2)</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow border-2 border-gray-400">
                  <div className="font-bold text-gray-800 mb-2">📢 Low (P3)</div>
                  <div className="text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-200">
              <h3 className="text-2xl font-bold mb-4 text-yellow-800">📊 Monitoring & Alerting</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📈 Key Metrics</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🚨 Alerts</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🔍 Distributed Tracing</div>
                  <div className="text-sm text-gray-600">
        ...
        {activeTab === 'scalability' && (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-2 border-red-200">
              <h3 className="text-2xl font-bold mb-4 text-red-800">🚦 Rate Limiting</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">👤 Per-User Rate Limiting</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🏢 Per-Service Rate Limiting</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🔧 Implementation</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Kafka Scaling */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
              <h3 className="text-2xl font-bold mb-4 text-blue-800">📬 Kafka Queue Scaling</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📊 Partitioning Strategy</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🔄 Consumer Groups</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">💾 Retention Policy</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Worker Scaling */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h3 className="text-2xl font-bold mb-4 text-green-800">⚙️ Worker Auto-Scaling</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📈 Scaling Metrics</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🐳 Kubernetes HPA</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">⚡ Batch Processing</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Database Scaling */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-200">
              <h3 className="text-2xl font-bold mb-4 text-purple-800">🗄️ Database Scaling</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">📚 Cassandra for Logs</div>
                  <div className="text-sm text-gray-600">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">🐘 PostgreSQL for Preferences</div>
                  <div className="text-sm text-gray-600">
                    • Shard by user_id<br/>
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-gray-800 mb-2">⚡ Redis for Rate Limiting</div>
                  <div className="text-sm text-gray-600">
            ...
            {/* Performance Targets */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border-2 border-orange-200">
              <h3 className="text-2xl font-bold mb-4 text-orange-800">📊 Performance Targets</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="text-2xl font-bold text-orange-600 mb-1">10M+/sec</div>
                  <div className="text-sm text-gray-600">Peak throughput</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="text-2xl font-bold text-orange-600 mb-1">{'<'} 1 sec</div>
                  <div className="text-sm text-gray-600">Push notification latency (p95)</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                ...
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="text-2xl font-bold text-orange-600 mb-1">{'<'} 0.1%</div>
                  <div className="text-sm text-gray-600">Duplicate notification rate</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'api' && (
          <div className="space-y-6">
            {/* API Overview */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200">
              <h2 className="text-2xl font-bold mb-4 text-green-800">🔌 Notification API Overview</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-green-600 mb-2">Base URL</div>
                  <code className="text-sm text-gray-700">https://api.notifications.com/v1</code>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-green-600 mb-2">Authentication</div>
                  <code className="text-sm text-gray-700">API Key + OAuth 2.0</code>
                </div>
                <div className="bg-white rounded-lg p-4 shadow">
                  <div className="font-bold text-green-600 mb-2">Rate Limit</div>
                  <code className="text-sm text-gray-700">1000 req/min per service</code>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">📤 Send Notification APIs</h3>

              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">POST</span>
                    <code className="text-sm text-gray-700">/notifications/send</code>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">Send a notification to one or more users</p>
...
{`{
  ...
  "priority": "high"
                ...
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">POST</span>
                    <code className="text-sm text-gray-700">/notifications/send/bulk</code>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">Send notification to many users (batch)</p>
                  <div className="bg-gray-50 p-3 rounded">
                    <pre className="text-xs text-gray-700 overflow-x-auto">
{`{
  ...
  "variables": {
    "company_name": "Acme Inc"
                ...
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">POST</span>
                    <code className="text-sm text-gray-700">/notifications/send/topic</code>
                  </div>
                  <p className="text-sm text-gray-600">Send notification to all users subscribed to a topic</p>
                </div>

                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">POST</span>
                    <code className="text-sm text-gray-700">/notifications/schedule</code>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">Schedule a notification for later</p>
                  <div className="bg-gray-50 p-3 rounded">
                    <pre className="text-xs text-gray-700 overflow-x-auto">
{`{
  "user_ids": ["user123"],
  ...
  "scheduled_at": "2024-01-20T10:00:00Z"
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">⚙️ User Preferences APIs</h3>

              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-bold">GET</span>
                    <code className="text-sm text-gray-700">/users/:userId/preferences</code>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">Get user's notification preferences</p>
                  <div className="bg-gray-50 p-3 rounded">
                    <pre className="text-xs text-gray-700 overflow-x-auto">
{`{
  "user_id": "user123",
    ...
    "sms": {
      "enabled": false
                ...
                <div className="border-l-4 border-yellow-500 pl-4 py-2">
                  ...
                  <p className="text-sm text-gray-600">Update notification preferences</p>
                </div>

                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">POST</span>
                    <code className="text-sm text-gray-700">/users/:userId/devices</code>
                  </div>
                ...
                <div className="border-l-4 border-red-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <code className="text-sm text-gray-700">/users/:userId/devices/:deviceId</code>
                  </div>
                  <p className="text-sm text-gray-600">Unregister a device</p>
                </div>
              </div>
            </div>
            ...
            {/* Template APIs */}
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">📝 Template APIs</h3>

              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">POST</span>
                    <code className="text-sm text-gray-700">/templates</code>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">Create a notification template</p>
                  <div className="bg-gray-50 p-3 rounded">
                    <pre className="text-xs text-gray-700 overflow-x-auto">
{`{
  "name": "order_shipped",
  ...
  "variables": ["user_name", "order_id"]
                ...
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-bold">GET</span>
                    <code className="text-sm text-gray-700">/templates/:templateId</code>
                  </div>
                  <p className="text-sm text-gray-600">Get template details</p>
                </div>
                ...
                <div className="border-l-4 border-yellow-500 pl-4 py-2">
                  ...
                  <p className="text-sm text-gray-600">Update a template</p>
                </div>
                ...
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  ...
                  <p className="text-sm text-gray-600">List all templates</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">📊 Status & Analytics APIs</h3>

              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-bold">GET</span>
                    <code className="text-sm text-gray-700">/notifications/:notificationId/status</code>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">Check notification delivery status</p>
                  <div className="bg-gray-50 p-3 rounded">
                    <pre className="text-xs text-gray-700 overflow-x-auto">
{`{
  ...
  "opened_at": "2024-01-20T10:05:00Z"
                ...
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-bold">GET</span>
                    <code className="text-sm text-gray-700">/notifications/:notificationId/analytics</code>
                  </div>
                  <p className="text-sm text-gray-600">Get analytics (delivery rate, open rate, click rate)</p>
                </div>

                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-bold">GET</span>
                    <code className="text-sm text-gray-700">/users/:userId/notifications</code>
                  </div>
                  <p className="text-sm text-gray-600">Get user's notification history</p>
                </div>
              </div>
            </div>
