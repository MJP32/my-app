...
export default function GoogleDocs({ onBack }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex gap-2 flex-wrap">
            <span className="px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium border border-blue-100">WebSocket Real-Time</span>
            <span className="px-4 py-2 bg-green-50 text-green-700 rounded-lg text-sm font-medium border border-green-100">Operational Transform</span>
            <span className="px-4 py-2 bg-purple-50 text-purple-700 rounded-lg text-sm font-medium border border-purple-100">Eventual Consistency</span>
            <span className="px-4 py-2 bg-orange-50 text-orange-700 rounded-lg text-sm font-medium border border-orange-100">Distributed System</span>
            <span className="px-4 py-2 bg-pink-50 text-pink-700 rounded-lg text-sm font-medium border border-pink-100">Event Streaming</span>
          </div>
        </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border-2 border-blue-200 shadow-lg">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">System Overview</h2>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg">
                <svg viewBox="0 0 1000 700" className="w-full h-auto">
                  ...
                  {/* Title */}
                  <text x="500" y="30" fontSize="20" fontWeight="bold" fill="#1f2937" textAnchor="middle">
                  ...
                  {/* WebSocket Servers */}
                  <text x="300" y="310" fontSize="16" fontWeight="bold" fill="#1f2937" textAnchor="middle">WebSocket Server Cluster</text>
                  ...
                  {/* Backend Services */}
                  <text x="300" y="460" fontSize="16" fontWeight="bold" fill="#1f2937" textAnchor="middle">Backend Services</text>
                  ...
                  {/* Storage Layer */}
                  <text x="300" y="600" fontSize="16" fontWeight="bold" fill="#1f2937" textAnchor="middle">Storage Layer</text>
                  ...
                  {/* CDN */}
                  <rect x="800" y="80" width="150" height="80" fill="#e0e7ff" stroke="#6366f1" strokeWidth="2" rx="6" />
                  <text x="875" y="110" fontSize="13" fontWeight="600" fill="#3730a3" textAnchor="middle">CDN</text>
                  <text x="875" y="130" fontSize="11" fill="#4f46e5" textAnchor="middle">Static Assets</text>
                  <text x="875" y="145" fontSize="10" fill="#6366f1" textAnchor="middle">Editor JS/CSS</text>

                  {/* Arrows */}
                  <path d="M 120 160 L 240 210" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                  <path d="M 300 160 L 300 210" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                  <path d="M 480 160 L 360 210" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />

                  <path d="M 210 260 L 145 330" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                  <path d="M 300 260 L 300 330" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                  <path d="M 390 260 L 455 330" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />

                  <path d="M 520 365 L 590 300" stroke="#6b7280" strokeWidth="2" strokeDasharray="5,5" />
                  <path d="M 300 400 L 675 400" stroke="#6b7280" strokeWidth="2" strokeDasharray="5,5" />
                  <path d="M 145 400 L 145 480" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />

                  <path d="M 120 540 L 120 620" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                  <path d="M 290 540 L 290 620" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                  <path d="M 460 540 L 460 620" stroke="#6b7280" strokeWidth="2" markerEnd="url(#arrow)" />
                </svg>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'components' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* WebSocket Server */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border-2 border-green-200 shadow-sm">
                <h3 className="text-xl font-bold text-green-900 mb-4">🌐 WebSocket Server</h3>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border-2 border-blue-200 shadow-sm">
                <h3 className="text-xl font-bold text-blue-900 mb-4">🔄 Operational Transform (OT)</h3>
              ...
              {/* CRDT */}
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border-2 border-orange-200 shadow-sm">
                <h3 className="text-xl font-bold text-orange-900 mb-4">📊 CRDT (Alternative to OT)</h3>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border-2 border-purple-200 shadow-sm">
                <h3 className="text-xl font-bold text-purple-900 mb-4">💾 Document Storage</h3>
              ...
              {/* Caching Strategy */}
              <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-6 border-2 border-pink-200 shadow-sm">
                <h3 className="text-xl font-bold text-pink-900 mb-4">⚡ Caching Strategy</h3>
              ...
              {/* Version History */}
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-6 border-2 border-emerald-200 shadow-sm">
                <h3 className="text-xl font-bold text-emerald-900 mb-4">📜 Version History</h3>
        ...
        {activeTab === 'dataflow' && (
          <div className="space-y-8">
            {/* User Edit Flow */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Data Flow: User Makes an Edit</h2>
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border-2 border-gray-200 shadow-lg">
                <div className="space-y-4 font-mono text-sm">
                  <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500">
                    <div className="font-bold text-blue-900 mb-2">1. User Types</div>
                    <div className="text-gray-700 ml-4">↓ Client captures keystroke (e.g., insert "H" at position 10)</div>
                    <div className="text-blue-700 ml-4 mt-1">↓ Generate operation: {`{ type: 'insert', pos: 10, char: 'H', userId: 'user123', version: 42 }`}</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-green-500">
                    <div className="font-bold text-green-900 mb-2">2. Optimistic Update</div>
                    <div className="text-gray-700 ml-4">↓ Immediately show "H" in local editor (no lag)</div>
                    <div className="text-green-700 ml-4 mt-1">↓ User sees instant feedback</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-purple-500">
                    <div className="font-bold text-purple-900 mb-2">3. Send to Server</div>
                    <div className="text-gray-700 ml-4">↓ WebSocket sends operation to WS server</div>
                    <div className="text-purple-700 ml-4 mt-1">↓ Persistent connection, no HTTP overhead</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-orange-500">
                    <div className="font-bold text-orange-900 mb-2">4. OT/CRDT Transform</div>
                    <div className="text-gray-700 ml-4">↓ Server applies Operational Transform</div>
                    <div className="text-orange-700 ml-4">↓ Check for concurrent edits from other users</div>
                    <div className="text-orange-700 ml-4">↓ Transform operation if needed (e.g., adjust position)</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-indigo-500">
                    <div className="font-bold text-indigo-900 mb-2">5. Persist to DB</div>
                    <div className="text-gray-700 ml-4">↓ Append operation to operations log</div>
                    <div className="text-indigo-700 ml-4">↓ Write to PostgreSQL/MongoDB</div>
                    <div className="text-indigo-700 ml-4">↓ Update document version to 43</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-pink-500">
                    <div className="font-bold text-pink-900 mb-2">6. Broadcast via Pub/Sub</div>
                    <div className="text-gray-700 ml-4">↓ Publish to Kafka/RabbitMQ</div>
                    <div className="text-pink-700 ml-4">↓ Topic: doc_edits_123 (document ID)</div>
                    <div className="text-pink-700 ml-4">↓ All WS servers subscribe to this topic</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-teal-500">
                    <div className="font-bold text-teal-900 mb-2">7. Push to Clients</div>
                    <div className="text-gray-700 ml-4">↓ Each WS server pushes to connected clients</div>
                    <div className="text-teal-700 ml-4">↓ All other users see "H" appear at position 10</div>
                    <div className="text-teal-700 ml-4">↓ Cursor positions updated if necessary</div>
                  </div>

                  <div className="bg-white p-4 rounded-lg border-l-4 border-cyan-500">
                    <div className="font-bold text-cyan-900 mb-2">8. Update Cache</div>
                    <div className="text-gray-700 ml-4">↓ Redis cache updated with latest doc state</div>
                    <div className="text-cyan-700 ml-4">↓ Next read will be fast (cache hit)</div>
                  </div>
            ...
            {/* Conflict Resolution */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Operational Transform - Conflict Resolution Example</h2>
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-8 border-2 border-yellow-300 shadow-lg">
                <div className="text-lg font-bold text-yellow-900 mb-6">Scenario: Two users edit simultaneously</div>

                <div className="bg-white rounded-xl p-6 space-y-4 font-mono text-sm border-2 border-yellow-200">
                  <div className="text-gray-900">
                    <strong>Initial Document State:</strong> "Hello World" (version 10)
                  </div>

                  <div className="border-t-2 border-gray-200 pt-4">
                    <div className="text-blue-900 font-bold">User A Operation:</div>
                    <div className="ml-4 text-gray-700">Insert "Beautiful " at position 6</div>
                    <div className="ml-4 text-blue-700">→ {`{ type: 'insert', pos: 6, text: 'Beautiful ', version: 10 }`}</div>
                    <div className="ml-4 text-gray-700">→ User A's view: "Hello <span className="bg-green-200">Beautiful </span>World"</div>
                  </div>

                  <div className="border-t-2 border-gray-200 pt-4">
                    <div className="text-purple-900 font-bold">User B Operation:</div>
                    <div className="ml-4 text-gray-700">Delete characters 0-5 (delete "Hello")</div>
                    <div className="ml-4 text-purple-700">→ {`{ type: 'delete', pos: 0, len: 5, version: 10 }`}</div>
                    <div className="ml-4 text-gray-700">→ User B's view: "<span className="bg-red-200 line-through">Hello</span> World"</div>
                  </div>

                  <div className="bg-red-50 p-4 rounded-lg border-2 border-red-300">
                    <div className="text-red-900 font-bold">❌ Conflict: Both operations based on version 10!</div>
                  </div>

                  <div className="border-t-2 border-gray-200 pt-4">
                    <div className="text-gray-900 font-bold mb-2">Server Receives Both:</div>
                    <div className="ml-4 space-y-2">
                      <div>1. User A's operation arrives first → Applied → Doc version 11</div>
                      <div className="ml-4 text-gray-700">Document: "Hello Beautiful World"</div>
                      <div className="mt-2">2. User B's operation arrives second → <strong className="text-orange-600">Must Transform!</strong></div>
                      <div className="ml-4 text-orange-700">Original op: Delete(0, 5) based on version 10</div>
                      <div className="ml-4 text-green-700">Transformed op: Delete(0, 5) - User A inserted after pos 6, doesn't affect this delete</div>
                      <div className="ml-4 text-gray-700">Apply delete → Doc version 12</div>
                    </div>
                  </div>

                  <div className="bg-green-50 p-4 rounded-lg border-2 border-green-300">
                    <div className="text-green-900 font-bold">✅ Final Converged State: " Beautiful World" (version 12)</div>
                    <div className="text-green-700 italic ml-4 mt-2">All clients eventually converge to this state</div>
                  </div>
                </div>

                <div className="mt-6 text-sm text-yellow-800 italic">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl p-6 border-2 border-cyan-200 shadow-sm">
                  <h3 className="text-lg font-bold text-cyan-900 mb-3">🌍 Geographic Distribution</h3>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border-2 border-green-200 shadow-sm">
                  <h3 className="text-lg font-bold text-green-900 mb-3">⚡ Connection Pooling</h3>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border-2 border-orange-200 shadow-sm">
                  <h3 className="text-lg font-bold text-orange-900 mb-3">📦 Operation Batching</h3>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border-2 border-purple-200 shadow-sm">
                  <h3 className="text-lg font-bold text-purple-900 mb-3">💾 Differential Sync</h3>
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-6 border-2 border-pink-200 shadow-sm">
                  <h3 className="text-lg font-bold text-pink-900 mb-3">🔒 Security & Auth</h3>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-6 border-2 border-emerald-200 shadow-sm">
                  <h3 className="text-lg font-bold text-emerald-900 mb-3">📊 Monitoring & Observability</h3>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border-2 border-gray-200 shadow-lg">
                <div className="space-y-6 font-mono text-sm">
                  <div className="bg-white p-6 rounded-xl border-l-4 border-blue-500">
                    <div className="font-bold text-blue-900 mb-3 text-lg">Assumptions</div>
                  ...
                  <div className="bg-white p-6 rounded-xl border-l-4 border-green-500">
                    <div className="font-bold text-green-900 mb-3 text-lg">Storage</div>
                    <div className="space-y-1 text-gray-700">
                      <div>• 500M total documents</div>
                      <div>• Average doc size: 50 KB (text + metadata)</div>
                      <div>• Total: 500M * 50 KB = 25 TB</div>
                      <div className="text-green-700 font-bold">• With version history (10x): 250 TB</div>
                    </div>
                  </div>

                  <div className="bg-white p-6 rounded-xl border-l-4 border-purple-500">
                    <div className="font-bold text-purple-900 mb-3 text-lg">Bandwidth</div>
                    <div className="space-y-1 text-gray-700">
                      <div>• 10M DAU * 5 docs * 100 edits = 5B operations/day</div>
                      <div>• 5B / 86400 sec ≈ 58K operations/sec</div>
                      <div className="text-purple-700 font-bold">• Peak (3x average): ~175K ops/sec</div>
                      <div>• Operation size: 200 bytes (JSON)</div>
                      <div className="text-purple-700 font-bold">• Bandwidth: 175K * 200 bytes = 35 MB/sec = 280 Mbps</div>
                    </div>
                  </div>

                  <div className="bg-white p-6 rounded-xl border-l-4 border-orange-500">
                    <div className="font-bold text-orange-900 mb-3 text-lg">WebSocket Servers</div>
                    <div className="space-y-1 text-gray-700">
                      <div>• 1M concurrent connections</div>
                      <div>• Each server handles 50K connections</div>
                      <div className="text-orange-700 font-bold">• Required servers: 1M / 50K = 20 servers</div>
                      <div className="text-orange-700 font-bold">• With 2x redundancy: 40 servers</div>
                    </div>
                  </div>

                  <div className="bg-white p-6 rounded-xl border-l-4 border-pink-500">
                    <div className="font-bold text-pink-900 mb-3 text-lg">Database</div>
                    <div className="space-y-1 text-gray-700">
                      ...
                      <div className="text-pink-700 font-bold">• Total DB instances: 30 (10 primaries + 20 replicas)</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 border-2 border-orange-300 shadow-lg">
                  <h3 className="text-xl font-bold text-orange-900 mb-4">1. OT vs CRDT</h3>
                  <div className="space-y-3 text-orange-800">
                    <div><strong className="text-orange-900">OT Pros:</strong> More mature, better for text, simpler data structures</div>
                    <div><strong className="text-orange-900">OT Cons:</strong> Requires centralized server for transform, complex algorithm</div>
                    <div><strong className="text-orange-900">CRDT Pros:</strong> Decentralized, guaranteed convergence, simpler logic</div>
                    <div><strong className="text-orange-900">CRDT Cons:</strong> Complex data structures, higher memory usage</div>
                    <div className="bg-white p-4 rounded-lg border-l-4 border-orange-500 mt-4">
                      <strong className="text-orange-900">Decision:</strong> Use OT for simplicity (Google Docs uses OT)
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 border-2 border-purple-300 shadow-lg">
                  <h3 className="text-xl font-bold text-purple-900 mb-4">2. Consistency vs Availability (CAP Theorem)</h3>
                  <div className="space-y-3 text-purple-800">
                    <div><strong className="text-purple-900">Trade-off:</strong> Can't have both strong consistency AND high availability in distributed system</div>
                    <div className="bg-white p-4 rounded-lg border-l-4 border-purple-500">
                      <strong className="text-purple-900">Decision:</strong> Choose Availability + Eventual Consistency
                    </div>
                    <div><strong className="text-purple-900">Reasoning:</strong> Users can tolerate seeing slightly stale cursor positions, but not disconnections</div>
                  </div>
                </div>

                {/* WebSocket vs Long Polling */}
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border-2 border-blue-300 shadow-lg">
                  <h3 className="text-xl font-bold text-blue-900 mb-4">3. WebSocket vs Long Polling</h3>
                  <div className="space-y-3 text-blue-800">
                    <div><strong className="text-blue-900">WebSocket Pros:</strong> True real-time, bidirectional, low latency</div>
                    <div><strong className="text-blue-900">WebSocket Cons:</strong> Not supported by all proxies/firewalls</div>
                    <div><strong className="text-blue-900">Long Polling:</strong> Fallback for legacy environments</div>
                    <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500 mt-4">
                      <strong className="text-blue-900">Decision:</strong> WebSocket primary, Long Polling fallback
                    </div>
                  </div>
                </div>
              </div>
