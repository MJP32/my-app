...
export default function RideShare({ onBack }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight">Fault-Tolerant Ride Share</h1>
            <span className="px-3 py-1 bg-green-100 text-green-700 rounded-lg text-xs font-bold uppercase tracking-wide">High Availability</span>
          </div>
          ...
          <div className="flex gap-2 flex-wrap">
            <span className="px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium border border-blue-100">Multi-AZ Deployment</span>
            <span className="px-4 py-2 bg-green-50 text-green-700 rounded-lg text-sm font-medium border border-green-100">Auto-Scaling</span>
            <span className="px-4 py-2 bg-purple-50 text-purple-700 rounded-lg text-sm font-medium border border-purple-100">Circuit Breakers</span>
            <span className="px-4 py-2 bg-orange-50 text-orange-700 rounded-lg text-sm font-medium border border-orange-100">Real-Time Matching</span>
            <span className="px-4 py-2 bg-pink-50 text-pink-700 rounded-lg text-sm font-medium border border-pink-100">Geospatial Indexing</span>
          </div>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 border-2 border-gray-200 shadow-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="flex items-center gap-3 bg-blue-100 p-3 rounded-lg border-2 border-blue-300">
                  <div className="w-4 h-4 bg-blue-500 rounded"></div>
                  <span className="font-semibold text-blue-900">Client Layer</span>
                </div>
                <div className="flex items-center gap-3 bg-purple-100 p-3 rounded-lg border-2 border-purple-300">
                  <div className="w-4 h-4 bg-purple-500 rounded"></div>
                  <span className="font-semibold text-purple-900">Gateway</span>
                </div>
                <div className="flex items-center gap-3 bg-indigo-100 p-3 rounded-lg border-2 border-indigo-300">
                  <div className="w-4 h-4 bg-indigo-500 rounded"></div>
                  <span className="font-semibold text-indigo-900">Service Mesh</span>
                </div>
                <div className="flex items-center gap-3 bg-green-100 p-3 rounded-lg border-2 border-green-300">
                  <div className="w-4 h-4 bg-green-500 rounded"></div>
                  <span className="font-semibold text-green-900">Application Services</span>
                </div>
                <div className="flex items-center gap-3 bg-cyan-100 p-3 rounded-lg border-2 border-cyan-300">
                  <div className="w-4 h-4 bg-cyan-500 rounded"></div>
                  <span className="font-semibold text-cyan-900">Geospatial</span>
                </div>
                <div className="flex items-center gap-3 bg-pink-100 p-3 rounded-lg border-2 border-pink-300">
                  <div className="w-4 h-4 bg-pink-500 rounded"></div>
                  <span className="font-semibold text-pink-900">Message Bus</span>
                </div>
                <div className="flex items-center gap-3 bg-yellow-100 p-3 rounded-lg border-2 border-yellow-300">
                  <div className="w-4 h-4 bg-yellow-600 rounded"></div>
                  <span className="font-semibold text-yellow-900">Data Stores</span>
                </div>
                <div className="flex items-center gap-3 bg-orange-100 p-3 rounded-lg border-2 border-orange-300">
                  <div className="w-4 h-4 bg-orange-500 rounded"></div>
                  <span className="font-semibold text-orange-900">External Services</span>
                </div>
                <div className="flex items-center gap-3 bg-red-100 p-3 rounded-lg border-2 border-red-300">
                  <div className="w-4 h-4 bg-red-500 rounded"></div>
                  <span className="font-semibold text-red-900">Observability</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-2xl p-8 border-2 border-indigo-300 shadow-2xl">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                ...
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-purple-100 border-2 border-purple-500 rounded-lg px-4 py-2 text-center mt-2">
                      ...
                      <div className="text-xs text-purple-700">Single entry point • HTTPS/TLS 1.3</div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-indigo-100 border-2 border-indigo-500 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-indigo-900 text-sm">Service Mesh Pattern</div>
                      <div className="text-xs text-indigo-700">Sidecar Proxy • mTLS</div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-green-100 border-2 border-green-500 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-green-900 text-sm">Circuit Breaker Pattern</div>
                      <div className="text-xs text-green-700">Fault Tolerance • Resilience4j</div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-cyan-100 border-2 border-cyan-500 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-cyan-900 text-sm">Geospatial Indexing</div>
                      <div className="text-xs text-cyan-700">GEORADIUS • {'<500ms'} • 5km radius</div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-pink-100 border-2 border-pink-500 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-pink-900 text-sm">Event-Driven Architecture</div>
                      <div className="text-xs text-pink-700">Pub/Sub • Async • 100K msgs/sec</div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-yellow-100 border-2 border-yellow-600 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-yellow-900 text-sm">Database per Service</div>
                      <div className="text-xs text-yellow-700">Polyglot Persistence • No Shared DB</div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-orange-100 border-2 border-orange-500 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-orange-900 text-sm">Cache-Aside Pattern</div>
                      <div className="text-xs text-orange-700">95% hit rate • 10x faster</div>
                    </div>
                  </div>
              ...
              <div>
                <div className="flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="bg-red-100 border-2 border-red-500 rounded-lg px-4 py-2 text-center mt-2">
                      <div className="font-bold text-red-900 text-sm">Distributed Tracing</div>
                      <div className="text-xs text-red-700">OpenTelemetry • Jaeger • 10% sampling</div>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-8 border-2 border-slate-300 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl border-2 border-purple-200 shadow-sm">
                  ...
                  <p className="text-sm text-gray-600">Single entry point for all client requests with authentication, rate limiting, and request routing.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-indigo-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Service Mesh</h3>
                  </div>
                  <p className="text-sm text-gray-600">Sidecar proxy pattern (Envoy) for service-to-service communication with mTLS and traffic management.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-green-200 shadow-sm">
                  ...
                  <p className="text-sm text-gray-600">Prevents cascade failures by opening circuit after consecutive failures and testing with half-open state.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-cyan-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Geospatial Indexing</h3>
                  </div>
                  <p className="text-sm text-gray-600">Redis GEORADIUS for sub-500ms driver matching within 5km radius with PostGIS fallback.</p>
                </div>

                <div className="bg-white p-6 rounded-xl border-2 border-pink-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-pink-500 text-white rounded-lg flex items-center justify-center font-bold text-lg">5</div>
                    <h3 className="text-lg font-bold text-gray-900">Event-Driven</h3>
                  </div>
                  <p className="text-sm text-gray-600">Asynchronous communication via Kafka pub/sub for loose coupling and scalability (100K msgs/sec).</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-yellow-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Database per Service</h3>
                  </div>
                  <p className="text-sm text-gray-600">Polyglot persistence - each service owns its database (PostgreSQL, MongoDB, Cassandra, Redis).</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-orange-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Cache-Aside</h3>
                  </div>
                  <p className="text-sm text-gray-600">Multi-layer caching (CDN/Redis/App) with 95% hit rate and 10x latency reduction.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-red-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Distributed Tracing</h3>
                  </div>
                  <p className="text-sm text-gray-600">OpenTelemetry + Jaeger for request tracing across microservices with 10% production sampling.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border-2 border-blue-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Auto-Scaling</h3>
                  </div>
                  <p className="text-sm text-gray-600">Horizontal scaling based on CPU (&gt;70%) and request count (&gt;1000/min) with 5-50 instances.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              return (
                <div key={component.id}>
                  ...
                  {expandedSections[component.id] && (
                    <div className="bg-gray-50 mt-3 p-6 rounded-xl border border-gray-200">
                      {/* Components */}
                      ...
                      <div className="space-y-3">
                        {component.faultTolerance.map((strategy, i) => (
                          <div key={i} className="flex gap-3 bg-white p-4 rounded-lg border border-green-100">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-semibold">{step.latency}</span>
                        </div>
                        <p className="text-gray-700 mb-3">{step.description}</p>
                        <div className="bg-blue-50 p-3 rounded-lg mb-3">
                          <p className="text-sm text-blue-900 font-mono">{step.details}</p>
                        </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                {systemScale.metrics.map((metric, i) => (
                  <div key={i} className="bg-white p-6 rounded-xl border border-blue-100 shadow-sm">
                    <h3 className="text-lg font-bold text-gray-900 mb-4">{metric.metric}</h3>
                    <div className="space-y-2.5">
                      <p className="text-3xl font-bold text-blue-600">{metric.value}</p>
                      <p className="text-sm text-gray-700"><span className="font-semibold text-gray-900">Calculation:</span> {metric.calculation}</p>
        ...
        {activeTab === 'recovery' && (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 border border-red-200 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              ...
              <div className="space-y-4">
                {disasterRecovery.strategies.map((strategy, i) => (
                  <div key={i} className="bg-white p-6 rounded-xl border border-red-100 shadow-sm">
                    <h3 className="text-lg font-bold text-gray-900 mb-4">{strategy.scenario}</h3>
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        <p className="text-xs text-gray-500 uppercase font-semibold mb-1">RTO (Recovery Time)</p>
                        <p className="text-lg font-bold text-orange-600">{strategy.rto}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 uppercase font-semibold mb-1">RPO (Data Loss)</p>
                        <p className="text-lg font-bold text-orange-600">{strategy.rpo}</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm text-gray-700"><span className="font-semibold text-gray-900">Impact:</span> {strategy.impact}</p>
                      <div className="bg-green-50 p-3 rounded-lg border border-green-200">
                        <p className="text-sm text-green-800">
